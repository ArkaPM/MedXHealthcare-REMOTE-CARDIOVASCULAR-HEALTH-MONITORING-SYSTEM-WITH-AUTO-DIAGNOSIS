...
cred = credentials.Certificate('./medxbot-firebase-adminsdk-7mkx7-1122e0610f.json')

firebase_admin.initialize_app(cred, {
    'databaseURL' : 'https://medxbot.firebaseio.com/'
})
...
employ_data = open('./MedxBot_Data.csv', 'w')
